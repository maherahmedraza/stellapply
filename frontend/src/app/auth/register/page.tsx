...
export default function RegisterPage() {
    ...
    return (
        <div className="min-h-screen bg-paper-bg dark:bg-background flex flex-col md:flex-row relative overflow-hidden">
            ...
            {/* Hero Side */}
            <div className="flex-1 bg-ink-blue/5 p-8 md:p-20 flex flex-col justify-center border-b-4 md:border-b-0 md:border-r-4 border-dashed border-pencil-black/20">
                ...
                <h1 className="text-5xl md:text-7xl font-marker text-pencil-black mb-8 leading-none -rotate-1">
                    Start your <span className="text-marker-red underline decoration-dashed underline-offset-8">career sketch</span> today.
                </h1>

                <p className="text-2xl font-handwritten text-pencil-black/80 mb-12 max-w-lg leading-relaxed">
                ...
                <div className="space-y-6">
                    {[
                        ...
                        <div key={i} className="flex items-center gap-4 group">
                            <div className="w-8 h-8 wobble border-2 border-pencil-black bg-white flex items-center justify-center shadow-sketch-sm group-hover:scale-110 transition-transform">
                                <CheckCircle2 className="w-5 h-5 text-ink-blue" strokeWidth={3} />
                            </div>
                            <span className="text-2xl font-handwritten font-bold text-pencil-black/90">{text}</span>
                        </div>
                    ))}
                </div>
            </div>
            ...
            <div className="flex-1 p-8 md:p-20 flex items-center justify-center bg-paper-bg relative">
                ...
                <div className="w-full max-w-md">
                    <SketchCard decoration="none" className="rotate-1 shadow-sketch-lg px-8 py-10 bg-white">
                        ...
                        <form onSubmit={handleRegister} className="space-y-6" noValidate>
                            ...
                            <div className="space-y-4 py-4 border-y border-dashed border-pencil-black/10">
                                <SketchCheckbox
